    ...
    <div class="container">
        <div class="card__container">
            <article class="card__article">
                <img src="{{ asset('images/anggrek.jpg') }}" alt="image" class="card__img">

                <div class="card__data">
                    <span class="card__description">Bunga</span>
                    <h2 class="card__title">Anggrek</h2>
                    <a href="{{ url('detailbunga') }}" class="card__button">Selengkapnya</a>
                </div>
            </article>

            <article class="card__article">
                <img src="{{ asset('images/dahlia.jpg') }}" alt="image" class="card__img">

                <div class="card__data">
                    <span class="card__description">Bunga</span>
                    <h2 class="card__title">Dahlia</h2>
                    <a href="{{ url('detailbunga') }}"" class="card__button">Selengkapnya</a>
                </div>
            </article>

            <article class="card__article">
                <img src="{{ asset('images/mawar.jpeg') }}" alt="image" class="card__img">

                <div class="card__data">
                    <span class="card__description">Bunga</span>
                    <h2 class="card__title">Mawar</h2>
                    <a href="{{ url('detailbunga') }}" class="card__button">Selengkapnya</a>
                </div>
            </article>
        </div>
