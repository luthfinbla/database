    ...
    <div class="container">
        <div class="card__container">
            <article class="card__article">
                <img src="{{ asset('images/sawi.jpg') }}" alt="image" class="card__img">

                <div class="card__data">
                    <span class="card__description">Sayur</span>
                    <h2 class="card__title">Sawi</h2>
                    <a href="{{ url('detailsayur') }}"  class="card__button">Selengkapnya</a>
                </div>
            </article>

            <article class="card__article">
                <img src="{{ asset('images/wortel.jpg') }}" alt="image" class="card__img">

                <div class="card__data">
                    <span class="card__description">Sayur</span>
                    <h2 class="card__title">Wortel</h2>
                    <a href="{{ url('detailsayur') }}" class="card__button">Selengkapnya</a>
                </div>
            </article>

            <article class="card__article">
                <img src="{{ asset('images/kentang.jpeg') }}" alt="image" class="card__img">

                <div class="card__data">
                    <span class="card__description">Sayur</span>
                    <h2 class="card__title">Kentang</h2>
                    <a href="{{ url('detailsayur') }}"  class="card__button">Selengkapnya</a>
                </div>
            </article>
        </div>
