        ...
        <section class="table_body">
            <table>
                ...
                <tbody>
                    <tr>
                        <td> FLW1 </td>
                        <td><img src="{{ asset('images/anggrek.jpg') }}" alt=""></td>
                        <td> Anggrek </td>
                        <td> <a href="{{ url('#') }}" style="text-decoration: none;color:black"><u>Selengkapnya</u></a> </td>
                        <td>
                            <button type="delete" class="delete-button" formaction="{{ url('bunga') }}">
                    ...
                    <tr>
                        <td> FLW2 </td>
                        <td><img src="{{ asset('images/dahlia.jpg') }}" alt=""></td>
                        <td> Dahlia </td>
                        <td> <a href="{{ url('#') }}" style="text-decoration: none;color:black"><u>Selengkapnya</u></a> </td>
                        <td>
                            <button type="delete" class="delete-button" formaction="{{ url('bunga') }}">
