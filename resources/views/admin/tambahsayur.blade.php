...
<body>
    ...
    {{-- card tambah data --}}
    <div class="card">
        <form action="{{ route('sayuraftertambah') }}" method="post" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
                ...
                <input type="text" id="id_tanaman" name="id_tanaman" placeholder="Masukkan ID Tanaman" required>
            </div>
            <div class="form-group">
                <label for="deskripsi_tanaman">Deskripsi</label>
                <input type="text" id="deskripsi_tanaman" name="deskripsi_tanaman" placeholder="Masukkan Deskripsi Tanaman" required>
            </div>
            <div class="form-group">
                <label for="cara_merawat">Cara Merawat</label>
                <textarea type="text" id="cara_merawat_tanaman" name="cara_merawat_tanaman" placeholder="Masukkan Cara Merawat Tanaman" required></textarea>
            </div>
            <div class="form-group">
                <label for="jenis_tanah">Tanah</label>
                <textarea type="text" id="tanah_tanaman" name="tanah_tanaman" placeholder="Masukkan Jenis Tanah Tanaman" required></textarea>
            </div>
            <div class="form-group">
